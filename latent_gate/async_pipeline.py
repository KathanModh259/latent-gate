...
class AsyncLatentGatePipeline:
    ...
    def pipeline(self) -> LatentGatePipeline:
        ...
        if not self._pipeline:
            raise RuntimeError("Pipeline not initialized. Use 'async with' or call _init_pipeline()")
    ...
    async def query_batch(self, image_paths: list, question: str) -> list:
        """
        ...
        """
        return await asyncio.to_thread(self.pipeline.query_batch, image_paths, question)
